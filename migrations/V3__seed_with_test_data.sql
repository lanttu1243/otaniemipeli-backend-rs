...
values ('Lauta 2025'),
       ('Lauta 2001'),
       ('Lauta 1985');
insert into ingredients (name, abv, carbonated)
values ('Kalja', 4.7, true),
       ('Slime', 40.0, false),
...
VALUES ('Metroasema',
        'Kaikki joukkueet aloittavat pelin Tietotien metroaseman luona olevalta pysäkiltä. Jokainen joukkue juo tuomarin päätöksen mukaisen määrän tuomarin päättämää juomaa.',
        'special'),
       ...
       ('Raide-Jokeri',
        'Raide-Jokeri teleporttaa joukkueen Maarin pysäkille. Matkan aikana nälkä yllättää ja joukkue hankkii K-Marketista lasillisen hyytelöä.',
        'special'),
       ...
       ('Suo', 'Lintutornista selvittyään joukkue joutuu vielä kahlaamaan suon läpi ja nauttimaan annoksen suohautaa.',
        'special'),
       ('Alvari', 'Alvariin saapuvaa joukkuetta odottaa tavalliseen tapaan lasillinen hyytelöä.', 'food'),
       ('Prodekon kiltahuone',
        'Prodekon kiltahuoneella juodaan tuopillinen Thunderia. Thunder ei tunnetusti lopu tarpeeksi ajoissa.',
        'guild'),
       ('OLOhuone', 'OLOhuoneella juodaankin tequilaa!', 'guild'),
       ('Database',
        'DG:n kiltahuoneella juomana on glitterillä koristeltua Trocaderoa. Yleisön vaatiessa terästettynä.', 'guild'),
       ('SIKin kiltahuone', 'SIKin kiltahuoneella tarjoillaan annos kuulalaakeria.', 'guild'),
       ('ASki',
        'AS:n kiltiksellä pelataan AShuikkaa. Siispä ruudussa on keskituoppi sisältäen kaljaa, siideriä ja punkkua suhteessa 1:1:1.',
        'guild'),
       ('TUASin ruokala', 'TUASin ruokalaan saapuvaa joukkuetta odottaa tavalliseen tapaan lasillinen hyytelöä.',
        'food'),
       ('T-talon ruokala', 'T-talon ruokalaan saapuvaa joukkuetta odottaa tavalliseen tapaan lasillinen hyytelöä.',
        'food'),
       ('Design Factory',
        'Joukkue keksii uuden startup-idean ja saa suunnitella seuraavalle saapuvalle joukkueelle drinkin isännän ja emännän ilmoittamasta ainesosavalikoimasta.',
        'special'),
       ('Sähkölaitos', 'Sähkölaitokselta saa kaljan sijaan piristävän energiajuoman.', 'special'),
       ('Vanha kiltis',
        'Vanhan kiltahuoneen muistoksi kiltahuoneella on aluksi yksi kalja. Ruutu täydennetään jokaisen joukkueen jälkeen. Jokaisen käynnin jälkeen ruutuun ilmestyy yksi kalja enemmän kuin edellisellä kerralla!',
        'guild'),
       ('IK:n kiltis',
        'Rakennusinsinöörikillan kiltahuoneella pelataan pikainen Norske Kimble. Joukkue heittää kahta noppaa ja saa pienemmän silmäluvun mukaisen määrän kaljapulloja juotavakseen.',
        'guild'),
       ...
       ('Maarintalo, excubussi',
        'Excubussi kaappaa joukuueen mukaansa Tampereelle. Joukkue voi halutessaan tilata bussimatkalle juotavaa (kola, kalja, siideri, punkku).',
        'special'),
       ('Miinusmaa', 'Joukkue saa annoksen haukea.', 'special'),
       ('Ylioppilaiden terveydenhuoltosäätiö',
        'YTHS:llä joukkue saa kaljapullon sijasta juotavakseen snapsilasillisen pirtua. Hätätilassa käy myös esim. A12-denaturoitu sprii.',
        'special'),
       ('Tietokillan varasto',
        'Tietokillan varastolla pelataankin ykköstä joukkueiden välillä. Joukkueet heittävät yhtä noppaa alkaen ruutuun saapuneesta joukkueesta. Ensimmäisenä ykkösen heittänyt joukkue voittaa annoksen pelijuomaa, ideaalisesti 1:1 appelsiinimehulla lantrattu 80%:lla vodkalla. Tuplilla ruutuun saapuessa heitetään kahteen ykköseen asti.',
        'special'),
       ('Taikametsä',
        ...
        'special'),
       ('Kappeli',
        'Kappelissa joukkueelle tarjotaan tavanomaisen kaljan sijaan lasillinen ehtoollisviiniä, joka tulee nauttia ennen matkan jatkamista.',
        'special'),
       ...
       ('Otaranta 8',
        'Myöskään Otarannan kattosaunalta ei kalja lopu kesken. Ruutu täytetään jokaisen joukkueen jälkeen.', 'sauna'),
       ...
       ('Vanha ostari',
        'Vanhan ostarin monipuolinen tarjonta innoittaa joukkueen hankkimaan sekä lasillisen hyytelöä että oluen palanpainikkeeksi.',
        'food'),
       ...
       ('Mikontalo', 'Mikontalo tekee kiljua Kioton sopimusta uhmaten! Joukkue juo lasin kotiviiniä eli punkkua.',
        'special'),
       ('Kultainen apina', 'Kapinasta ei kalja lopu. Joukkue juo yhden oluen.', 'special'),
       ('TiTen kiltahuone',
        'Kiltahuone muuttaa Kolaa koodiksi. Joukkue juo lasin kolaa. Terästettynä yleisön vaatiessa.', 'guild'),
       ('Teekkarisauna',
        'Joukkue on päätynyt teekkarisaunalle, jossa ohjelmassa on teekkarisauna™. Joukkue joutuu nauttimaan kolme pulloa kaljaa sekä lasillisen hyytelöä ennen kuin voi jatkaa matkaa.',
        'sauna'),
       ('Tupsula',
        'Käyt padassa ja hörppäät puoli litraa patavettä. Varo kortsuja! Ryhmä juo puoli litraa lämmintä lonkeroa, jossa saattaa olla kondomi.',
        'special'),
       ('Etuparkki. excubussi',
        'Joukkueen päästessä tähän ruutuun (yli menevät heitot lasketaan) excubussi vie takaisin Otaniemeen. Joukkue voi halutessaan tilata bussimatkalle juotavaa (kola, kalja, siideri, punkku). Otaniemessä joukkue saapuukin sopivasti Smökkiin sitsaamaan.',
        'special'),
       ('Maarinsolmu', 'Joukkue saapuu Maarinsolmuun ja ostaa lasillisen hyytelöä.', 'food'),
       ('Urheilukenttä',
        'Urheilukentän kohdalla sinne ensimmäiseksi saapunut joukkue suorittaa 110 metrin aidat eli juo kolme pulloa olutta, ennenkuin pääsee jatkamaan. Ruutua ei täydennetä!',
        'special'),
       ('Ostari', 'Otariisto, R-Kioski ja Jamoi. Kalja ei kaupasta lopu.Ruutu täydennetään jokaisen joukkueen jälkeen!',
        'sauna'),
       ('Puunjalostajakillan kiltahuone',
        'Vierailu puunjalostajien kiltahuoneella.Ruutu täydennetään jokaisen joukkueen jälkeen!', 'guild'),
       ('Vuorilafkan ruokala', 'Vuoren ruokalaan saapuvaa joukkuetta odottaa tavalliseen tapaan lasillinen hyytelöä.',
        'food'),
       ('Kemman lafkan kuppila', 'Kemman lafkan kuppilaan saapuvaa odottaa tavalliseen tapaan lasillinen hyytelöä.',
        'food'),
       ...
       ('Sähkön ruokala',
        ...
        'food'),
       ('Uimahalli', 'Uimahallilla juodaankin kaljan sijasta vissyä. Uimahallista ei myöskään juotava lopu.',
        'special'),
